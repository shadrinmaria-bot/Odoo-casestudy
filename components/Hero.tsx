...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-content -translate-y-[100px] flex-1 flex-col justify-center px-6 py-12 text-center md:px-10 md:py-7">
        <motion.h1
          {...fade(0.1)}
